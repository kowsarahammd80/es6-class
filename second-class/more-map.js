...
let thirds = numbers.map(n => n/3)
// console.log(half);
// console.log( thirds);

let friends = ['Tom hanks', 'tom cruise', 'tom brady', 'tom solaiman'];

let firstLetters = friends.map(friend => friend[0]);

// console.log(firstLetters);

let nameLenghts = friends.map(friend => friend.length);
...
// let items = products.map(product => console.log(product));
